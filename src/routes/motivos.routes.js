 ...
 *          description: Error
 */
router.get('/motivos', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getMotivos);
 ...
 *          
 */
router.get('/motivos/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getMotivosByID);
 ...
 *          
 */
router.get('/motivos/category/:name', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getMotivosByCategoria);
 ...
 *          
 */
router.post('/motivos', [authMiddleware, authorize(['administrador', 'acceso limitado'])], createMotivos);
 ...
 *          
 */
router.put('/motivos', [authMiddleware, authorize(['administrador'])], updateMotivos);
 ...
 *          
 */
router.delete('/motivos/:id', [authMiddleware, authorize(['administrador'])], deleteMotivos);
