...
const { getClientes,getClientesByID,getClientesByCedula,createClientes,updateClientes,deleteClientes, getCountClientes } = require('../controllers/clientes.controller');
 ...
 */
router.get('/clientes', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getClientes);
 ...
 *  /clientes/count:
 *    get:
 *      summary: Obtener el conteo de todos los clientes
 *      description: Devuelve el conteo de todos los clientes
 *      tags: 
 *        - clientes
 *      security:
 *        - BearerAuth: []
 ...
 *          description: Error
 */
router.get('/clientes/count', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getCountClientes);
 ...
 *          
 */
router.get('/clientes/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getClientesByID);
 ...
 *          
 */
router.get('/clientes/cedula/:cedula', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getClientesByCedula);
 ...
 *          
 */
router.post('/clientes', [authMiddleware, authorize(['administrador', 'acceso limitado'])], createClientes);
 ...
 *          
 */
router.put('/clientes', [authMiddleware, authorize(['administrador'])], updateClientes);
 ...
 *          
 */
router.delete('/clientes/:id', [authMiddleware, authorize(['administrador'])], deleteClientes);
