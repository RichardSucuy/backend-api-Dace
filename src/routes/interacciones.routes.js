...
const { getInteracciones,getInteraccionesByID,getInteraccionesByUser,getInteraccionesByAgencia,getInteraccionesByCanal,getInteraccionesByTema,createInteracciones,updateInteracciones,deleteInteracciones, getCountInteracciones, getUltimasInteracciones, getActividadReciente} = require('../controllers/interacciones.controller');
 ...
 *          description: Error
 */
router.get('/interacciones', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getInteracciones);
 ...
 *  /interacciones/count:
 *    get:
 *      summary: Obtener el conteo de todas las interacciones
 *      description: Devuelve el conteo de todas las interacciones
 *      tags: 
 *        - interacciones
 *      security:
 *        - BearerAuth: []
 ...
 *          description: Error
 */
router.get('/interacciones/count', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getCountInteracciones);

/**
 * @swagger
 * paths:
 *  /interacciones/ultimas:
 *    get:
 *      summary: Obtener las últimas interacciones
 *      description: Devuelve las últimas interacciones
 *      tags: 
 *        - interacciones
 *      security:
 *        - BearerAuth: []
 ...
 *          description: Error
 */
router.get('/interacciones/ultimas', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getUltimasInteracciones);

/**
 * @swagger
 * paths:
 *  /interacciones/actividad-reciente:
 *    get:
 *      summary: Obtener la actividad reciente
 *      description: Devuelve la actividad reciente
 *      tags: 
 *        - interacciones
 *      security:
 *        - BearerAuth: []
 ...
 *          description: Error
 */
router.get('/interacciones/actividad-reciente', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getActividadReciente);
 ...
 *          description: Error          
 */
router.get('/interacciones/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getInteraccionesByID);
 ...
 *          
 */
router.get('/interacciones/usuario/:user', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getInteraccionesByUser);
 ...
 *          
 */
router.get('/interacciones/agencia/:agen', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getInteraccionesByAgencia);
 ...
 *          
 */
router.get('/interacciones/canal/:can', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getInteraccionesByCanal);
 ...
 *          
 */
router.get('/interacciones/tema/:tem', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getInteraccionesByTema);
 ...
 *          
 */
router.post('/interacciones', [authMiddleware, authorize(['administrador', 'acceso limitado'])], createInteracciones);
 ...
 *          
 */
router.put('/interacciones', [authMiddleware, authorize(['administrador'])], updateInteracciones);
 ...
 *          
 */
router.delete('/interacciones/:id', [authMiddleware, authorize(['administrador'])], deleteInteracciones);
