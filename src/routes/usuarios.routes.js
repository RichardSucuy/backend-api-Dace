 ...
 *          description: Error
 */
router.get('/usuarios', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getUsuarios);
 ...
 *          
 */
router.get('/usuarios/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getUsuariosByID);
 ...
 *          
 */
router.get('/usuarios/cedula/:ced', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getUsuariosByCed);
 ...
 *          
 */
router.post('/usuarios', [authMiddleware, authorize(['administrador', 'acceso limitado'])], createUsuarios);
 ...
 *          
 */
router.put('/usuarios', [authMiddleware, authorize(['administrador'])], updateUsuarios);
 ...
 *          
 */
router.delete('/usuarios/:id', [authMiddleware, authorize(['administrador'])], deleteUsuarios);
