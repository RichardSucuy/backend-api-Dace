 ...
 *          description: Error
 */
router.get('/agencias', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getAgencias);
 ...
 *          
 */
router.get('/agencias/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getAgenciasByID);
 ...
 *          
 */
router.get('/agencias/city/:name', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getAgenciasByCity);
 ...
 *          
 */
router.post('/agencias', [authMiddleware, authorize(['administrador', 'acceso limitado'])], createAgencias);
 ...
 *          
 */
router.put('/agencias', [authMiddleware, authorize(['administrador'])], updateAgencias);
 ...
 *          
 */
router.delete('/agencias/:id', [authMiddleware, authorize(['administrador'])], deleteAgencias);
