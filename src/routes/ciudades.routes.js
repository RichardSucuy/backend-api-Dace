 ...
 */
router.get('/ciudades', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getCiudades);
 ...
 *          
 */
router.get('/ciudades/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getCiudadesByID);
 ...
 *          
 */
router.get('/ciudades/city/:name', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getCiudadesByCity);
 ...
 *          
 */
router.post('/ciudades', [authMiddleware, authorize(['admin', 'acceso limitado'])], createCiudades);
 ...
 *          
 */
router.put('/ciudades', [authMiddleware, authorize(['admin'])], updateCiudades);
 ...
 *          
 */
router.delete('/ciudades/:id', [authMiddleware, authorize(['administrador'])], deleteCiudades);
