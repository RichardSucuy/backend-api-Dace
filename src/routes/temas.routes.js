 ...
 *          description: Error
 */
router.get('/temas', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getTemas);
 ...
 *          
 */
router.get('/temas/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getTemasByID);
 ...
 *          
 */
router.post('/temas', [authMiddleware, authorize(['administrador', 'acceso limitado'])], createTemas);
 ...
 *          
 */
router.put('/temas', [authMiddleware, authorize(['administrador'])], updateTemas);
 ...
 *          
 */
router.delete('/temas/:id', [authMiddleware, authorize(['administrador'])], deleteTemas);
