 ...
 *          description: Error
 */
router.get('/canal', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getCanales);
 ...
 *          
 */
router.get('/canal/:id', [authMiddleware, authorize(['administrador', 'acceso limitado'])], getCanalByID);
 ...
 *          
 */
router.post('/canal', [authMiddleware, authorize(['administrador', 'acceso limitado'])], createCanal);
 ...
 *          
 */
router.put('/canal', [authMiddleware, authorize(['administrador'])], updateCanal);
 ...
 *          
 */
router.delete('/canal/:id', [authMiddleware, authorize(['administrador'])], deleteCanal);
